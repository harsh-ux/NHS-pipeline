...
from utils import populate_test_results_table, D_value_compute, RV_compute, predict_with_dt, label_encode
        ...
        while True:
            ...
            if hl7_data:
                ...
                if category == 'PAS-admit':
                    ...
                    aki = predict_with_dt(dt_model, [patient_history[0][1], patient_history[0][2], C1, RV1, RV1_ratio, RV2, RV2_ratio, True, D])
                    print(aki)
